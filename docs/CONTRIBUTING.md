How to contribute to Bogo
=========================

Thank you for considering contributing to Bogo. This document explains how you can contribute to the project. We ask all contributors to read through this first.
...
Receiving reports of issues that have little to do with the plugin negatively impacts the motivation of the developers. If you are uncertain, posting to the [support forum](https://wordpress.org/support/plugin/bogo/) is advised.
...
Everyday, a lot of users come to the [official support forum](https://wordpress.org/support/plugin/bogo/) to post their support requests. If you feel you can answer their questions, please do not hesitate to do so.
...
We use [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/bogo/) (GlotPress) to manage translations for the Bogo plugin. This is a collaborative translation platform in which thousands of volunteer translators participate.
...
Bogo is released under the GNU General Public License (GPL), and copyrights are protected. Please use this plugin while respecting the intellectual property rights.
